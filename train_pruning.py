...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    manager = ScheduledModifierManager.from_yaml(opt.receipt)
    print(len(dataloader))
    optimizer = manager.modify(model, optimizer, len(dataloader))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--receipt', type=str, default='receipts/yolov5s.pruned.md', help='receipt path')
    ...
    parser.add_argument('--saving_epoch', type=int, default=0, help='validation start point')
