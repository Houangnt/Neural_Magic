...
if __name__ == '__main__':
    ...
    input_names = ['input']
    output_names = ['output']
    exporter = ModuleExporter(model, output_dir=os.path.dirname(opt.weights))
    exporter.export_onnx(sample_batch=img,
                         name=os.path.basename(opt.weights).split('.')[0] + '.onnx',
